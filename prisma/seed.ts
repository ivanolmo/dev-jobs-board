...
const jobs: JobObject[] = [
  {
    company: "Scoot",
    logoUrl: "/logos/scoot.svg",
    logoBgColor: "#e99210",
    jobTitle: "Senior Software Engineer",
    createdAt: new Date("2023-02-28T00:00:00.000Z"),
    jobType: "Full Time",
    location: "United Kingdom",
    companyUrl: "https://example.com/scoot",
  ...
  {
    company: "Vector",
    logoUrl: "/logos/vector.svg",
    logoBgColor: "#34353f",
    jobTitle: "Midlevel Back End Engineer",
    createdAt: new Date("2023-01-12T00:00:00.000Z"),
    jobType: "Part Time",
    location: "Russia",
    companyUrl: "https://example.com/vector",
  ...
  },
  {
    ...
    createdAt: new Date("2023-02-08T00:00:00.000Z"),
    jobType: "Part Time",
    location: "Japan",
    companyUrl: "https://example.com/pod",
    ...
    duties: {
      content:
        "You will work closely with development teams to implement automation solutions using technologies like Amazon Web Services (AWS), Ansible, Jenkins, and Kubernetes to automatically build, test, integrate, and deploy complex, modern systems. You will leverage the full power of the cloud to configure highly resilient and scalable applications that support zero downtime. This jobTitle is open to a mid-level to senior professional depending on experience and background.",
      items: [
  ...
  },
  {
    ...
    requirements: {
      content:
        "You are likely someone with a solid background in end-user support and troubleshooting, as this jobTitle involves dealing with a large, and often changing, number of day-to-day issues which arise in supporting the information technology requirements of our applications.",
      items: [
  ...
  {
    company: "Pomodoro",
    logoUrl: "/logos/pomodoro.svg",
    logoBgColor: "#4722c6",
    jobTitle: "iOS Engineer",
    createdAt: new Date("2023-02-01T00:00:00.000Z"),
    jobType: "Full Time",
    location: "United States",
    companyUrl: "https://example.com/pomodoro",
  ...
  {
    company: "Maker",
    logoUrl: "/logos/maker.svg",
    logoBgColor: "#21427d",
    jobTitle: "Senior EJB Developer",
    createdAt: new Date("2023-03-21T00:00:00.000Z"),
    jobType: "Full Time",
    location: "United Kingdom",
    companyUrl: "https://example.com/maker",
  ...
  },
  {
    ...
    logoUrl: "/logos/coffeeroasters.svg",
    logoBgColor: "#f2decb",
    jobTitle: "Senior Frontend Developer",
    createdAt: new Date("2023-02-05T00:00:00.000Z"),
    jobType: "Part Time",
    location: "Singapore",
    companyUrl: "https://example.com/coffeeroasters",
  ...
  {
    company: "Crowdfund",
    logoUrl: "/logos/crowdfund.svg",
    logoBgColor: "#37c790",
    jobTitle: "Fullstack Developer",
    createdAt: new Date("2023-04-03T00:00:00.000Z"),
    jobType: "Part Time",
    location: "New Zealand",
    companyUrl: "https://example.com/crowdfund",
  ...
  {
    company: "Typemaster",
    logoUrl: "/logos/typemaster.svg",
    logoBgColor: "#f16718",
    jobTitle: "Technical Lead Engineer",
    createdAt: new Date("2023-02-23T00:00:00.000Z"),
    jobType: "Part Time",
    location: "United Kingdom",
    companyUrl: "https://example.com/typemaster",
  ...
  },
  {
    ...
    createdAt: new Date("2023-01-28T00:00:00.000Z"),
    jobType: "Full Time",
    location: "Singapore",
    companyUrl: "https://example.com/coffeeroasters",
    applyUrl: "https://example.com/coffeeroasters/apply",
    ...
    requirements: {
      content:
        "This is an entry level full stack developer jobTitle that will assist in developing the next generation apps and APIs. You will be a contributor to agile teams by providing services that ensure Coffeeroasters is aligning technology efforts with business information needs. The intent is to develop a junior full stack developer to become a well-rounded API developer ready to take on any challenging opportunity.",
      items: [
  ...
  },
  {
    ...
    logoUrl: "/logos/blogr.svg",
    logoBgColor: "#e54d25",
    jobTitle: "Midweight Front-end Developer",
    createdAt: new Date("2023-02-12T00:00:00.000Z"),
    jobType: "Full Time",
    location: "United States",
    companyUrl: "https://example.com/blogr",
    applyUrl: "https://example.com/blogr/apply",
...
async function insertJobs(jobs: JobObject[]) {
